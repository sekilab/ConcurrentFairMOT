...
class opts(object):
  def __init__(self):
    ...
    # test
    self.parser.add_argument('--K', type=int, default=550,
    ...
    self.parser.add_argument('--keep_res', action='store_true',
                             help='keep the original resolution'
                                  ' during validation.')
    # tracking
    self.parser.add_argument('--val_seq_file', default="TH2020_seqs.json", help='the name of the file containing the validation sequences')
    self.parser.add_argument('--demo_seq_file', default="TH2020_demo_seqs.json", help='the name of the file containing the demo sequences')
    ...
    self.parser.add_argument('--mot_frame_skip', type=int, default=0, help='The number of frames to skip for MOT task.')
    ...
    self.parser.add_argument('--input-root', type=str, default='../videos', help='root path containing demo videos')
    ...
    self.parser.add_argument('--cmc_on', action='store_true',
                             help='turn on camera motion cancellation')
    self.parser.add_argument('--cmc_type', default="aff", choices=["aff", "proj"],
                             help='turn on camera motion cancellation')
